...
%% MEMORY MAIN EFFECT ANALYSIS (COLLAPSED ACROSS NEU & NEG)
...
for i = 1:length(time_windows)
    ...
    GND = FclustGND(GND, ...
                    ...
                    'thresh_p', thresh_p, ...
                    'save_GND', 'no', ...
                    'output_file', fullfile('results', sprintf('EmCon_MemCollapsed_%d-%d.xlsx', time_wind(1), time_wind(2))), ...
                    'verblevel', 2);
                
end


%% VALENCE X MEMORY ANALYSIS
...
for i = 1:length(time_windows)
    ...
    GND = FclustGND(GND, ...
                    ...
                    'thresh_p', thresh_p, ...
                    'save_GND', 'no', ...
                    'output_file', fullfile('results', sprintf('EmCon_ValXMem_%d-%d.xlsx', time_wind(1), time_wind(2))), ...
                    'verblevel', 2);
                
end


%% ODDBALL X MEMORY ANALYSES
